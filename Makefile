...
genoapi:
	...
	go run github.com/oapi-codegen/oapi-codegen/v2/cmd/oapi-codegen -package worker -generate=types                        -o app/worker/gen/oapi/worker/oapi.go spec/worker-api.yml
	go mod tidy
